            ...
            do {
                ...
                for (Reservation reservation : response.reservations()) {
                    for (Instance instance : reservation.instances()) {
                        ...
                        System.out.println(  instance.state().nameAsString());

                        System.out.println("monitoring information is "+  instance.monitoring().state());
                        System.out.println(instance.instanceId().equals("i-088d3185e8eb74875"));
                        System.out.println(instance.state().nameAsString().equals("running"));
